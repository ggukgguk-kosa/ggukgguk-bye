...
type Friend struct {
	...
	Member1ID       string    `boil:"member1_id" json:"member1_id" toml:"member1_id" yaml:"member1_id"`
	Member2ID       string    `boil:"member2_id" json:"member2_id" toml:"member2_id" yaml:"member2_id"`
	FriendCreatedAt time.Time `boil:"friend_created_at" json:"friend_created_at" toml:"friend_created_at" yaml:"friend_created_at"`
...
var FriendColumns = struct {
	...
	FriendCreatedAt: "friend_created_at",
}
...
var FriendTableColumns = struct {
	...
	Member1ID:       "friend.member1_id",
	Member2ID:       "friend.member2_id",
	FriendCreatedAt: "friend.friend_created_at",
}
...
var FriendWhere = struct {
	...
	Member1ID       whereHelperstring
	Member2ID       whereHelperstring
	FriendCreatedAt whereHelpertime_Time
}{
	FriendID:        whereHelperint{field: "`friend`.`friend_id`"},
	Member1ID:       whereHelperstring{field: "`friend`.`member1_id`"},
	Member2ID:       whereHelperstring{field: "`friend`.`member2_id`"},
	FriendCreatedAt: whereHelpertime_Time{field: "`friend`.`friend_created_at`"},
}
...
type friendR struct {
	Member1 *Member `boil:"Member1" json:"Member1" toml:"Member1" yaml:"Member1"`
	Member2 *Member `boil:"Member2" json:"Member2" toml:"Member2" yaml:"Member2"`
}
...
func (r *friendR) GetMember1() *Member {
	if r == nil {
		return nil
	}
	return r.Member1
...
func (r *friendR) GetMember2() *Member {
	if r == nil {
		return nil
	}
	return r.Member2
...
var (
	friendAllColumns            = []string{"friend_id", "member1_id", "member2_id", "friend_created_at"}
	friendColumnsWithoutDefault = []string{"member1_id", "member2_id"}
	friendColumnsWithDefault    = []string{"friend_id", "friend_created_at"}
	friendPrimaryKeyColumns     = []string{"friend_id"}
...
func (q friendQuery) OneG(ctx context.Context) (*Friend, error) {
...
func (q friendQuery) AllG(ctx context.Context) (FriendSlice, error) {
...
// CountG returns the count of all Friend records in the query using the global executor
func (q friendQuery) CountG(ctx context.Context) (int64, error) {
...
func (q friendQuery) ExistsG(ctx context.Context) (bool, error) {
...
// Member1 pointed to by the foreign key.
func (o *Friend) Member1(mods ...qm.QueryMod) memberQuery {
	queryMods := []qm.QueryMod{
		qm.Where("`member_id` = ?", o.Member1ID),
	}
...
// Member2 pointed to by the foreign key.
func (o *Friend) Member2(mods ...qm.QueryMod) memberQuery {
	queryMods := []qm.QueryMod{
		qm.Where("`member_id` = ?", o.Member2ID),
	}
...
// LoadMember1 allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (friendL) LoadMember1(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFriend interface{}, mods queries.Applicator) error {
	var slice []*Friend
	var object *Friend
	...
	if singular {
		...
		object.R.Member1 = foreign
		if foreign.R == nil {
			foreign.R = &memberR{}
		}
		foreign.R.Member1Friends = append(foreign.R.Member1Friends, object)
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.Member1ID == foreign.MemberID {
				local.R.Member1 = foreign
				if foreign.R == nil {
					foreign.R = &memberR{}
				}
				foreign.R.Member1Friends = append(foreign.R.Member1Friends, local)
				break
			}
		}
	}
...
// LoadMember2 allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (friendL) LoadMember2(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFriend interface{}, mods queries.Applicator) error {
	var slice []*Friend
	var object *Friend
	...
	if singular {
		foreign := resultSlice[0]
		object.R.Member2 = foreign
		if foreign.R == nil {
			foreign.R = &memberR{}
		}
		foreign.R.Member2Friends = append(foreign.R.Member2Friends, object)
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.Member2ID == foreign.MemberID {
				local.R.Member2 = foreign
				if foreign.R == nil {
					foreign.R = &memberR{}
				}
				foreign.R.Member2Friends = append(foreign.R.Member2Friends, local)
				break
			}
		}
	}
...
// SetMember1G of the friend to the related item.
// Sets o.R.Member1 to related.
// Adds o to related.R.Member1Friends.
// Uses the global database handle.
func (o *Friend) SetMember1G(ctx context.Context, insert bool, related *Member) error {
	return o.SetMember1(ctx, boil.GetContextDB(), insert, related)
}

// SetMember1 of the friend to the related item.
// Sets o.R.Member1 to related.
// Adds o to related.R.Member1Friends.
func (o *Friend) SetMember1(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Member) error {
	var err error
	if insert {
	...
	values := []interface{}{related.MemberID, o.FriendID}
	...
	if related.R == nil {
		related.R = &memberR{
			Member1Friends: FriendSlice{o},
		}
	} else {
		related.R.Member1Friends = append(related.R.Member1Friends, o)
	}

	return nil
}

// SetMember2G of the friend to the related item.
// Sets o.R.Member2 to related.
// Adds o to related.R.Member2Friends.
// Uses the global database handle.
func (o *Friend) SetMember2G(ctx context.Context, insert bool, related *Member) error {
	return o.SetMember2(ctx, boil.GetContextDB(), insert, related)
}

// SetMember2 of the friend to the related item.
// Sets o.R.Member2 to related.
// Adds o to related.R.Member2Friends.
func (o *Friend) SetMember2(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Member) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if related.R == nil {
		related.R = &memberR{
			Member2Friends: FriendSlice{o},
		}
	} else {
		related.R.Member2Friends = append(related.R.Member2Friends, o)
	}
...
func FindFriendG(ctx context.Context, friendID int, selectCols ...string) (*Friend, error) {
	return FindFriend(ctx, boil.GetContextDB(), friendID, selectCols...)
}

// FindFriend retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindFriend(ctx context.Context, exec boil.ContextExecutor, friendID int, selectCols ...string) (*Friend, error) {
	friendObj := &Friend{}
	...
	query := fmt.Sprintf(
		"select %s from `friend` where `friend_id`=?", sel,
	)

	q := queries.Raw(query, friendID)
...
func (o *Friend) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *Friend) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	o.FriendID = int(lastID)
	if lastID != 0 && len(cache.retMapping) == 1 && cache.retMapping[0] == friendMapping["friend_id"] {
		goto CacheNoHooks
	}
...
func (o *Friend) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q friendQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o FriendSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Friend) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *Friend) DeleteG(ctx context.Context) (int64, error) {
...
func (q friendQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o FriendSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *Friend) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no Friend provided for reload")
	}
...
func (o *Friend) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindFriend(ctx, exec, o.FriendID)
	if err != nil {
		return err
	}
...
func (o *FriendSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty FriendSlice provided for reload all")
	}
...
func FriendExistsG(ctx context.Context, friendID int) (bool, error) {
	return FriendExists(ctx, boil.GetContextDB(), friendID)
}

// FriendExists checks if the Friend row exists.
func FriendExists(ctx context.Context, exec boil.ContextExecutor, friendID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `friend` where `friend_id`=? limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, friendID)
	}
	row := exec.QueryRowContext(ctx, sql, friendID)
...
func (o *Friend) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return FriendExists(ctx, exec, o.FriendID)
}
